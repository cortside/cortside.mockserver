...
if ($PSScriptRoot.Contains(' ')) { 
    throw "Your working directory has a space in the path, which is not supported.  Wise up and move to C:\work\Cortside.WireMock! And have a wonderful work day!"
    exit
}
